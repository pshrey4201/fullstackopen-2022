...
describe('most blogs', () => {
  ...
  test('list with equal blogs', () => {
    ...
    const result = listHelper.mostBlogs(listWithSameBlogNumbers)
    expect(result).toEqual(expected)
  })
})
...
describe('most likes', () => {
  ...
  test('list with equal blogs', () => {
    ...
    const result = listHelper.mostLikes(listWithSameBlogNumbers)
    expect(result).toEqual(expected)
  })
})